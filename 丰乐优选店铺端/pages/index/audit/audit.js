...
Page({
  ...
  formCheck:function(){
    ...
    if (that.data.bossName != '' && that.data.bossIdentity != '' && that.data.bossPhone != '' && that.data.bossWeChat != '' && that.data.bossBankCard != '' && that.data.bankOpenName != '' && that.data.bankOpenId != ''){
      that.setData({
        formComplete: true,
      })
    }
