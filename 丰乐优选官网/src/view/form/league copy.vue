<template>
  <div>
      <div>
        您的称呼：<input v-model="name" placeholder="请输入..."><br>
        您的联系方式：<input v-model="name" placeholder="请输入..."><br>
        意向代理城市：<input v-model="name" placeholder="请输入..."><br>
      </div>
